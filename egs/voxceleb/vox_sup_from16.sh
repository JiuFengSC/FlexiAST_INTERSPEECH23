...
t_model_path="/mnt/work2/users/fj/FlexiAST/voxceleb/exp/FT_Norm-CE-patch16_Base224_f16-t16-pTrue-b12/models/best_audio_model.pth"
t_n_class=1251
t_patch_size=16
t_fstride=16
t_tstride=16
...
exp_dir=/mnt/work2/users/${exp_user}/FlexiAST/time_only/${dataset}/reproduce_T16_Spatch${patch_size}_Base224_-b$batch_size-m$mixup
mkdir -p $exp_dir
